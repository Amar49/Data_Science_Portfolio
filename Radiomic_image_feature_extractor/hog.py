...
Each image is checked if its of 512X512 size, else its resized
The code reads images in greyscale.

The images are normalised for gamma, and then, for normal contrast
Each 512X512 image pixel matrix, is organised into 8X8 cells and then, histograms
...
if __name__ == '__main__':
	#path1 = '/home/amarendra/Desktop/Radiomics/HOG-master/new_train_data/cancerous'
	path1 = '/home/amarendra/Desktop/Radiomics/HOG-master/new_train_data/non_cancerous'
	#path2 = '/home/amarendra/Desktop/Radiomics/HOG-master/hog_files/cancerous/'
	path2 = '/home/amarendra/Desktop/Radiomics/HOG-master/hog_files/non_cancerous/'
	for filename in os.listdir(path1):
		new_file = filename[0:-4]
		f= open(path2+new_file+".txt","w+")
		f.close()
		print("File name: ",path1+'/'+filename," new_file: ",new_file)
		create_hog_file(path1+'/'+filename,path2+new_file+".txt")
		mg = read_hog_file(path2+new_file+".txt")
	print(mg)
	print(mg.shape)
